...
_FILTER_CACHE: tuple[Path | None, list[str]] | None = None


def load_filter_words(filter_json_path: Path | None = None) -> list[str]:
    """
...
def align_bilingual_cues(
...
) -> list[tuple[SubtitleCue | None, list[SubtitleCue]]]:
    ...
    """
    aligned: list[tuple[SubtitleCue | None, list[SubtitleCue]]] = []
    en_index = 0
    ...
    for idx, cue1 in enumerate(cues_lang1):
        ...
        next_start = cues_lang1[idx + 1].start if idx + 1 < len(cues_lang1) else float("inf")
        limit = (cue1.start + next_start) / 2.0 if next_start != float("inf") else float("inf")
...
def create_ttml_document(
    aligned_cues: list[tuple[SubtitleCue | None, list[SubtitleCue]]],
    lang1: str = "rus",
    lang2: str = "eng",
    default_lang: str = "en",
...
def cues_to_ttml(
    ...
    *,
    tolerance: float = 2.5,
    aligned_cues: list[tuple[SubtitleCue | None, list[SubtitleCue]]] | None = None,
    filter_words: list[str] | None = None,
) -> str:
    """
...
def vtt_files_to_ttml(
    ...
    *,
    tolerance: float = 2.5,
    cues_lang1: list[SubtitleCue] | None = None,
    cues_lang2: list[SubtitleCue] | None = None,
    aligned_cues: list[tuple[SubtitleCue | None, list[SubtitleCue]]] | None = None,
    filter_words: list[str] | None = None,
) -> str:
    """
