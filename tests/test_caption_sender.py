...
class TestSendCaption:
    ...
    def test_send_caption_success(self):
        ...
        with mock.patch("caption_sender.requests.post", return_value=mock_response) as mock_post:
            result = caption_sender.send_caption("localhost", 8086, "testStream", "Test caption")
    ...
    def test_send_caption_stream_not_found(self):
        ...
        with mock.patch("caption_sender.requests.post", return_value=mock_response):
            result = caption_sender.send_caption("localhost", 8086, "nonexistent", "Test caption")
    ...
    def test_send_caption_with_custom_language(self):
        ...
        with mock.patch("caption_sender.requests.post", return_value=mock_response) as mock_post:
            result = caption_sender.send_caption(
                "localhost", 8086, "testStream", "Test caption", language="spa", track_id=50
            )
            assert result is True
            call_args = mock_post.call_args
    ...
    def test_send_caption_with_authentication(self):
        ...
        with mock.patch("caption_sender.requests.post", return_value=mock_response) as mock_post:
            result = caption_sender.send_caption(
                "localhost", 8086, "testStream", "Test caption", username="admin", password="secret"
            )
            assert result is True
            call_args = mock_post.call_args
    ...
    def test_send_caption_payload_structure(self):
        ...
        with mock.patch("caption_sender.requests.post", return_value=mock_response) as mock_post:
            caption_sender.send_caption("localhost", 8086, "myStream", "Caption text", language="rus", track_id=100)
            call_args = mock_post.call_args
...
class TestMainFunction:
    ...
    def test_main_with_single_caption(self):
        ...
        test_args = ["caption_sender.py", "--stream", "testStream", "--count", "1"]
    ...
    def test_main_with_multiple_captions(self):
        ...
        test_args = ["caption_sender.py", "--stream", "testStream", "--count", "3"]
...
def run_all_tests():
    ...
    """
    test_classes = [TestSendCaption, TestMainFunction]
